...
import 'application/add_group/add_group_page_bloc.dart' as _i31;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i19.GroupOverviewBloc>(
      () => _i19.GroupOverviewBloc(get<_i9.IGroupsRepository>()));
  gh.factory<_i20.HomepageBloc>(
      () => _i20.HomepageBloc(get<_i9.IGroupsRepository>()));
  gh.singleton<_i21.IAuthenticationInterface>(
      _i22.AuthenticationRepository(get<_i17.AuthenticationApiService>()));
  gh.singleton<_i23.IChatsRepository>(
      _i24.ChatsRepository(get<_i18.ChatsApiService>()));
  gh.singleton<_i25.ISurveysRepository>(
      _i26.SurveysRepository(get<_i14.SurveysApiService>()));
  gh.singleton<_i27.IUsersRepository>(
      _i28.UsersRepository(get<_i16.UsersApiService>()));
