...
class BottomNavigationButtonsSurveySection extends StatelessWidget {
  final int stepIndex;
  final int totalQuestions;
  final List<SurveyRowInfo>? surveyQuestions;
  ...
  void handleNextOrCreateActionForIndex(BuildContext context,
      ...
      required List<Question>? surveyQuestions,
      required CreateNewType featureType}) {
    final newIndex = min(totalQuestions - 1, currentIndex + 1);
