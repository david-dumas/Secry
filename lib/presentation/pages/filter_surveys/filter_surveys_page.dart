...
class _FilterSurveysPageState extends State<FilterSurveysPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      getIt<FilterSurveyBloc>()
        ..add(const FilterSurveyEvent.initialized()),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(tr('filter_surveys_number_of_votes'),
                                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSizeMedium)),
                              SizedBox(height: marginSmall),
                              Text('${state.initialNumberOfVotesLowerBound.round()} - ${state.initialNumberOfVotesUpperBound.round()}+',
                              ...
                              CustomRangeSlider(
                                  ...
                                  handleChange: (double lowerBound, double upperBound) {
                                    context.read<FilterSurveyBloc>().add(FilterSurveyEvent.numberOfVotesUpdated(lowerBound, upperBound));
                                  },
                              ),
                              SizedBox(height: marginSmall),
                              Divider(thickness: 1),
