...
class AppRouter extends _i7.RootStackRouter {
  ...
  List<_i7.RouteConfig> get routes => [
        ...
        _i7.RouteConfig(TabbarPageRoute.name, path: '/tabbar-page'),
        _i7.RouteConfig(HomePageRoute.name, path: '/home-page'),
        _i7.RouteConfig(GlobalSearchPageRoute.name,
            path: '/global-search-page'),
        _i7.RouteConfig(SavedChatsAndSurveysPageRoute.name,
            path: '/saved-chats-and-surveys-page'),
        _i7.RouteConfig(AccountPageRoute.name, path: '/account-page')
      ];
}
...
class TabbarPageRoute extends _i7.PageRouteInfo<void> {
...
class GlobalSearchPageRoute extends _i7.PageRouteInfo<void> {
...
class SavedChatsAndSurveysPageRoute extends _i7.PageRouteInfo<void> {
