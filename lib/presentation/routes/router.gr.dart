...
class AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    GlobalSearchPageRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(routeData: routeData, child: const _i4.GlobalSearchPage());
    },
    ...
    AccountLoggedoutPageRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(routeData: routeData, child: const _i7.AccountLoggedoutPage());
    },
  ...
  List<_i14.RouteConfig> get routes => [
        ...
        _i14.RouteConfig(AccountLoggedoutPageRoute.name, path: '/account-loggedout-page'),
...
class GlobalSearchPageRoute extends _i14.PageRouteInfo<void> {
  const GlobalSearchPageRoute() : super(GlobalSearchPageRoute.name, path: '/global-search-page');
...
class AccountLoggedoutPageRoute extends _i14.PageRouteInfo<void> {
  const AccountLoggedoutPageRoute() : super(AccountLoggedoutPageRoute.name, path: '/account-loggedout-page');
...
class GroupOverviewPageRoute extends _i14.PageRouteInfo<GroupOverviewPageRouteArgs> {
  GroupOverviewPageRoute({_i16.Key? key, required String title, required String groupId})
