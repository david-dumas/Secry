...
class AddChatPageEvent with _$AddChatPageEvent {
  ...
  const factory AddChatPageEvent.chatTitleUpdated(String newTitle) =
      _GroupTitleUpdated;
  const factory AddChatPageEvent.chatImageUpdated(Image newImage) =
      _GroupImageUpdated;
  const factory AddChatPageEvent.chatImageDeleted() = _GroupImageDeleted;
  const factory AddChatPageEvent.currentStepIndexUpdated(int newIndex) =
      _CurrentStepIndexUpdated;
