...
class _$_AddSurveyPageState implements _AddSurveyPageState {
  ...
  @override
  String toString() {
    return 'AddSurveyPageState(surveyTitle: $surveyTitle, currentStepIndex: $currentStepIndex, isSurveySuccessfullyCreated: $isSurveySuccessfullyCreated, isCreateNewSurveyRequestExecuted: $isCreateNewSurveyRequestExecuted)';
  }
...
abstract class _AddSurveyPageState implements AddSurveyPageState {
  const factory _AddSurveyPageState(
      ...
      required int currentStepIndex,
      required bool isSurveySuccessfullyCreated,
      required bool isCreateNewSurveyRequestExecuted}) = _$_AddSurveyPageState;
