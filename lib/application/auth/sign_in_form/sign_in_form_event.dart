...
class SignInFormEvent with _$SignInFormEvent {
  ...
  const factory SignInFormEvent.continueWithGooglePressed() = _ContinueWithGooglePressed;
  const factory SignInFormEvent.continueWithFacebookPressed() = _ContinueWithFacebookPressed;
  const factory SignInFormEvent.continueWithTwitterPressed() = _ContinueWithTwitterPressed;
}
